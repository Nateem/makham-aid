angular.module('app')
	.controller('reportSome_customerController', function($rootScope,$filter,$scope,$http,notificationService){
        ...
        $scope.formSubmit = function(){
             $http({
                    method: "POST",
                    url: 'models/reportSome_customer.model.php',
                    data: {
                        TYPES: 'SELECT_reportSome_customer',
                        CURRENT_DATA: $rootScope.globals.currentDATA,
